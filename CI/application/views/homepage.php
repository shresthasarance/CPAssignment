...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Blue Bird Boys Hostel</title>
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center">
								...
								<p class="fh5co-social text-center" id="fh5co-intro-social">
									...
									<a href="https://www.plus.google.com" class="to-animate"><i class="icon-google-with-circle"></i></a>
									<a href="https://www.instagram.com" class="to-animate"><i class="icon-instagram-with-circle"></i></a>
								</p>
							</div>
						</div>
					</div>
								...
								<div class="col-md-3">
									...
									<ul class="fh5co-contact">
										<li class="fh5co-contact-address to-animate">
											<i class="icon-home"></i>
											Kathmandu Baneswor, Milanchowk
										</li>
										<li class="to-animate"><i class="icon-phone"></i> (+977) 123456789	</li>
